AGENT_NAME                  =       "Hide on Bush"
TEAM_NAME                   =       "SKT"

    
# These are algorithm parameters. You need to change this
DELTA                       =      0              #   How much should the epsilon shift by in every game
LR                          =      0.4           #   This is the learning rate. High learning rate means faster learning"                     
...
DESTROY_SOFTBLOCK           =      20      
DO_DAMAGE                   =      50
TAKE_DAMAGE                 =      -100     
EARN_AMMO                   =      10
COLLIDE_WITH_WALLS          =      -1
DAMAGE_ITSELF               =      -100        
NO_DESTRUCTION              =      0                 
NO_KILL                     =      0             
PLACING_BOMBS_WITH_NO_AMMO  =      -1
BOMB_IN_RANGE               =      -5
PLACING_BOMB_ON_TOP_OF_BOMB =      0
EXIST_PENALTY               =      0
...
COACH                       =       coachLizzie()                # choose between coachPango, coachLizzie, coachSiss
